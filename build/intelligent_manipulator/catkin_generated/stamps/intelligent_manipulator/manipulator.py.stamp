...
class Manipulator:
    def __init__(self):
        ...
        self.min_angles_d = [-45, -45, -45]
        self.max_angles_d = [45, 0, 45]
    ...
    def get_joint_angles(self):
        ...
        angles = list(angles)
        print(f"Angles got! {angles[0]:.2f} {angles[1]:.2f} {angles[2]:.2f}")
    ...
    def set_joint_angles(self, angles):
        ...
        try:
            ...
            print(f"Joint angles set! {pos[0]:.2f} {pos[1]:.2f} {pos[2]:.2f}")
            return resp1
        except rospy.ServiceException as e:
...
def callback(data, args):
    ...
    pub = args[1]
    action = data.action
    print(f"Action received: {action[0]:.2f} {action[1]:.2f} {action[2]:.2f}")
